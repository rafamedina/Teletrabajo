...
Skill activation via the `activate_skill` command is mandatory when relevant. The agent must use `tdd` for test-driven development and `find-docs` for technical documentation research. Once a skill is loaded, its instructions must be followed strictly.

## 3. Specialized Capabilities

skill-creator. Technical guide for creating or updating agent skills. Location: `/home/ikran/.npm-global/lib/node_modules/@google/gemini-cli/node_modules/@google/gemini-cli-core/dist/src/skills/builtin/skill-creator/SKILL.md`.
